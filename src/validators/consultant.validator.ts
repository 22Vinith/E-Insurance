...
class ConsultantValidator{
    ...
    public newConsultant = (req: Request, res: Response, next: NextFunction): void => {
      ...
      public loginConsultant = (req: Request, res: Response, next: NextFunction): void => {
        const schema = Joi.object({
          email: Joi.string().email().required(),
...
export default ConsultantValidator